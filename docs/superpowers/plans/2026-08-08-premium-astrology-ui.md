...
**Implementation status:** All planned implementation and verification steps have been executed on the feature branch; PR #74 remains unmerged and under review.
...
- CI/Linux examples use Bash. On Windows, run the listed PowerShell equivalent and `gradlew.bat`; do not invoke Bash-only `./gradlew`.
- Git commands are shell-neutral, but PowerShell examples use `;` instead of Bash `&&`.
...
- [x] **Step 1: Write the failing screenshot previews**
...
- [x] **Step 2: Run the focused screenshot compile**

Run (Bash/CI): `cd Astroloji && ./gradlew :app:validateDebugScreenshotTest -Pandroid.experimental.enableScreenshotTest=true -Pandroid.sync.suppressAgpWarnings=UNSUPPORTED_PROJECT_OPTION_USE`

Run (PowerShell): `Set-Location Astroloji; .\gradlew.bat :app:validateDebugScreenshotTest -Pandroid.experimental.enableScreenshotTest=true -Pandroid.sync.suppressAgpWarnings=UNSUPPORTED_PROJECT_OPTION_USE`
Expected: FAIL because the premium composables/palette are unresolved.

- [x] **Step 3: Implement palette, typography, and primitives**
...
- [x] **Step 4: Make existing shared components inherit the new visual language**
...
- [x] **Step 5: Run screenshot + static checks**

Run (Bash/CI): `cd Astroloji && ./gradlew :app:validateDebugScreenshotTest detekt ktlintCheck -Pandroid.experimental.enableScreenshotTest=true -Pandroid.sync.suppressAgpWarnings=UNSUPPORTED_PROJECT_OPTION_USE`

Run (PowerShell): `Set-Location Astroloji; .\gradlew.bat :app:validateDebugScreenshotTest detekt ktlintCheck -Pandroid.experimental.enableScreenshotTest=true -Pandroid.sync.suppressAgpWarnings=UNSUPPORTED_PROJECT_OPTION_USE`
Expected: PASS.
...
PowerShell: `git add Astroloji/app/src/main/java/com/parsfilo/astrology/ui/theme Astroloji/app/src/main/java/com/parsfilo/astrology/core/ui/components Astroloji/app/src/screenshotTest/kotlin/com/parsfilo/astrology/core/ui; git commit -m "feat(android): add premium astrology design system"`
...
- [x] **Step 1: Add a failing premium navigation screenshot preview**
...
- [x] **Step 4: Verify navigation behavior and screenshot tests**

Run (Bash/CI): `cd Astroloji && ./gradlew :app:testDebugUnitTest :app:validateDebugScreenshotTest -Pandroid.experimental.enableScreenshotTest=true -Pandroid.sync.suppressAgpWarnings=UNSUPPORTED_PROJECT_OPTION_USE`

Run (PowerShell): `Set-Location Astroloji; .\gradlew.bat :app:testDebugUnitTest :app:validateDebugScreenshotTest -Pandroid.experimental.enableScreenshotTest=true -Pandroid.sync.suppressAgpWarnings=UNSUPPORTED_PROJECT_OPTION_USE`
...
PowerShell: `git add Astroloji/app/src/main/java/com/parsfilo/astrology/navigation/AstrologyAppRoot.kt Astroloji/app/src/screenshotTest/kotlin/com/parsfilo/astrology/navigation; git commit -m "feat(android): refine premium navigation chrome"`
...
- [x] **Step 1: Add deterministic Home screenshot fixture**
...
- [x] **Step 4: Recompose daily metrics and commentary**
...
- [x] **Step 5: Verify state behavior and visual regression**

Run (Bash/CI): `cd Astroloji && ./gradlew :app:testDebugUnitTest --tests '*HomeViewModelTest' :app:validateDebugScreenshotTest -Pandroid.experimental.enableScreenshotTest=true -Pandroid.sync.suppressAgpWarnings=UNSUPPORTED_PROJECT_OPTION_USE`

Run (PowerShell): `Set-Location Astroloji; .\gradlew.bat :app:testDebugUnitTest --tests '*HomeViewModelTest' :app:validateDebugScreenshotTest -Pandroid.experimental.enableScreenshotTest=true -Pandroid.sync.suppressAgpWarnings=UNSUPPORTED_PROJECT_OPTION_USE`
Expected: PASS.
...
PowerShell: `git add Astroloji/app/src/main/java/com/parsfilo/astrology/feature/home/HomeScreen.kt Astroloji/app/src/screenshotTest/kotlin/com/parsfilo/astrology/feature/home; git commit -m "feat(android): redesign home as premium dashboard"`
...
- [x] **Step 1: Add failing deterministic screenshot fixtures**
...
- [x] **Step 4: Redesign Compatibility**
...
- [x] **Step 5: Run focused unit + screenshot suite**

Run (Bash/CI): `cd Astroloji && ./gradlew :app:testDebugUnitTest --tests '*DailyViewModelTest' --tests '*CompatibilityViewModelTest' --tests '*CompatibilityScorePresentationTest' :app:validateDebugScreenshotTest -Pandroid.experimental.enableScreenshotTest=true -Pandroid.sync.suppressAgpWarnings=UNSUPPORTED_PROJECT_OPTION_USE`

Run (PowerShell): `Set-Location Astroloji; .\gradlew.bat :app:testDebugUnitTest --tests '*DailyViewModelTest' --tests '*CompatibilityViewModelTest' --tests '*CompatibilityScorePresentationTest' :app:validateDebugScreenshotTest -Pandroid.experimental.enableScreenshotTest=true -Pandroid.sync.suppressAgpWarnings=UNSUPPORTED_PROJECT_OPTION_USE`
Expected: PASS.
...
PowerShell: `git add Astroloji/app/src/main/java/com/parsfilo/astrology/feature/daily Astroloji/app/src/main/java/com/parsfilo/astrology/feature/compatibility Astroloji/app/src/screenshotTest/kotlin/com/parsfilo/astrology/feature/daily Astroloji/app/src/screenshotTest/kotlin/com/parsfilo/astrology/feature/compatibility; git commit -m "feat(android): elevate horoscope detail surfaces"`
...
- [x] **Step 1: Update/add screenshot fixtures before implementation**
...
- [x] **Step 3: Redesign Premium around benefits + real plan selection**
...
- [x] **Step 4: Redesign Settings into premium grouped controls**
...
- [x] **Step 5: Run focused billing/settings + screenshot suite**

Run (Bash/CI): `cd Astroloji && ./gradlew :app:testDebugUnitTest --tests '*PremiumOfferPresentationTest' --tests '*PremiumViewModelTest' --tests '*StoreScreenshotQaBillingTest' --tests '*SettingsViewModelTest' :app:validateDebugScreenshotTest -Pandroid.experimental.enableScreenshotTest=true -Pandroid.sync.suppressAgpWarnings=UNSUPPORTED_PROJECT_OPTION_USE`

Run (PowerShell): `Set-Location Astroloji; .\gradlew.bat :app:testDebugUnitTest --tests '*PremiumOfferPresentationTest' --tests '*PremiumViewModelTest' --tests '*StoreScreenshotQaBillingTest' --tests '*SettingsViewModelTest' :app:validateDebugScreenshotTest -Pandroid.experimental.enableScreenshotTest=true -Pandroid.sync.suppressAgpWarnings=UNSUPPORTED_PROJECT_OPTION_USE`
Expected: PASS.
...
PowerShell: `git add Astroloji/app/src/main/java/com/parsfilo/astrology/feature/premium Astroloji/app/src/main/java/com/parsfilo/astrology/feature/settings Astroloji/app/src/screenshotTest/kotlin/com/parsfilo/astrology/feature/premium Astroloji/app/src/screenshotTest/kotlin/com/parsfilo/astrology/feature/settings; git commit -m "feat(android): polish premium and settings surfaces"`
...
- [x] **Step 1: Add/extend deterministic visual coverage for one representative secondary content screen**
...
- [x] **Step 2: Run screenshot validation and record RED**

Expected: old secondary presentation differs from the premium system.
- [x] **Step 3: Migrate secondary screens to shared premium primitives**
...
- [x] **Step 4: Verify feature unit tests and screenshot regression**
...
PowerShell: `git add Astroloji/app/src/main/java/com/parsfilo/astrology/feature Astroloji/app/src/screenshotTest; git commit -m "feat(android): unify premium content presentation"`
...
- [x] **Step 1: Run formatting and static analysis**

Run (Bash/CI): `cd Astroloji && ./gradlew detekt ktlintCheck lintDebug`

Run (PowerShell): `Set-Location Astroloji; .\gradlew.bat detekt ktlintCheck lintDebug`
Expected: PASS with no new warnings attributable to the redesign.

- [x] **Step 2: Run all JVM tests**

Run (Bash/CI): `cd Astroloji && ./gradlew :app:testDebugUnitTest`

Run (PowerShell): `Set-Location Astroloji; .\gradlew.bat :app:testDebugUnitTest`
Expected: PASS.

- [x] **Step 3: Run all Compose screenshot tests**
...
- [x] **Step 4: Build installable/release artifacts**

Run (Bash/CI): `cd Astroloji && ./gradlew :app:assembleDebug :app:bundleRelease`

Run (PowerShell): `Set-Location Astroloji; .\gradlew.bat :app:assembleDebug :app:bundleRelease`
Expected: PASS.

- [x] **Step 5: Run repository diff and behavior-scope audit**
...
- [x] **Step 7: Fresh final verification**

Re-run the full gate from the final immutable head and record the exact commit SHA and successful outputs before opening a PR. Release dry-run environment values must follow CI parity, including disabled Crashlytics mapping upload; do not hardcode production credentials.
