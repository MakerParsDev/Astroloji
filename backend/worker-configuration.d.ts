/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false --env-interface=CloudflareEnv` (hash: 873b4a02d082cf6bfe4b3da79963df68)
// Runtime types generated with workerd@1.20260730.1 2026-04-05 
interface __BaseEnv_CloudflareEnv {
	...
	PREMIUM_WEEKLY_PRODUCT_ID: string;
	ALLOWED_ORIGINS: string;
	RATE_LIMITER: DurableObjectNamespace<import("./src/index").RateLimitBucket>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RateLimitBucket";
	}
