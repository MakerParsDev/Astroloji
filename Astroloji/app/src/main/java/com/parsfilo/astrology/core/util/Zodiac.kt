...
enum class ZodiacSign(
    ...
    ARIES("aries", "Koç", "Aries", "♈", 3, 21, 4, 19, ZodiacElement.FIRE, "Mars", R.drawable.ic_zodiac_generic),
    TAURUS("taurus", "Boğa", "Taurus", "♉", 4, 20, 5, 20, ZodiacElement.EARTH, "Venüs", R.drawable.ic_zodiac_generic),
    GEMINI("gemini", "İkizler", "Gemini", "♊", 5, 21, 6, 20, ZodiacElement.AIR, "Merkür", R.drawable.ic_zodiac_generic),
    CANCER("cancer", "Yengeç", "Cancer", "♋", 6, 21, 7, 22, ZodiacElement.WATER, "Ay", R.drawable.ic_zodiac_generic),
    LEO("leo", "Aslan", "Leo", "♌", 7, 23, 8, 22, ZodiacElement.FIRE, "Güneş", R.drawable.ic_zodiac_generic),
    VIRGO("virgo", "Başak", "Virgo", "♍", 8, 23, 9, 22, ZodiacElement.EARTH, "Merkür", R.drawable.ic_zodiac_generic),
    LIBRA("libra", "Terazi", "Libra", "♎", 9, 23, 10, 22, ZodiacElement.AIR, "Venüs", R.drawable.ic_zodiac_generic),
    SCORPIO("scorpio", "Akrep", "Scorpio", "♏", 10, 23, 11, 21, ZodiacElement.WATER, "Plüton", R.drawable.ic_zodiac_generic),
    SAGITTARIUS("sagittarius", "Yay", "Sagittarius", "♐", 11, 22, 12, 21, ZodiacElement.FIRE, "Jüpiter", R.drawable.ic_zodiac_generic),
    CAPRICORN("capricorn", "Oğlak", "Capricorn", "♑", 12, 22, 1, 19, ZodiacElement.EARTH, "Satürn", R.drawable.ic_zodiac_generic),
    AQUARIUS("aquarius", "Kova", "Aquarius", "♒", 1, 20, 2, 18, ZodiacElement.AIR, "Uranüs", R.drawable.ic_zodiac_generic),
    PISCES("pisces", "Balık", "Pisces", "♓", 2, 19, 3, 20, ZodiacElement.WATER, "Neptün", R.drawable.ic_zodiac_generic),
    ;
    ...
    fun localizedDateRange(language: String): String {
        val locale =
            if (TimeUtils.normalizeLanguageTag(language) == "tr") {
